...
class FormTemplateServiceTest {
    ...
    class GetAllTemplatesTests {
        ...
        void getAllTemplates_ShouldReturnAll() {
            ...
            // When
            List<FormTemplateResp> result = templateService.getAllTemplates();
    ...
    class GetEnabledTemplatesTests {
        ...
        void getEnabledTemplates_ShouldReturnEnabled() {
            ...
            // When
            List<FormTemplateResp> result = templateService.getEnabledTemplates();
    ...
    class GetTemplatesByCategoryTests {
        ...
        void getTemplatesByCategory_ShouldReturnByCategory() {
            ...
            // When
            List<FormTemplateResp> result = templateService.getTemplatesByCategory("hr");
        ...
        void getTemplatesByCategory_WhenNone_ShouldReturnEmptyList() {
            ...
            // When
            List<FormTemplateResp> result = templateService.getTemplatesByCategory("finance");
    ...
    class GetTemplateByIdTests {
        ...
        void getTemplateById_WhenExists_ShouldReturnTemplate() {
            ...
            // When
            FormTemplateResp result = templateService.getTemplateById("template-001");
        ...
        void getTemplateById_WhenNotFound_ShouldReturnNull() {
            ...
            // When
            FormTemplateResp result = templateService.getTemplateById("non-existent");
    ...
    class GetTemplateByCodeTests {
        ...
        void getTemplateByCode_WhenExists_ShouldReturnTemplate() {
            ...
            // When
            FormTemplateResp result = templateService.getTemplateByCode("leave_request");
        ...
        void getTemplateByCode_WhenNotFound_ShouldReturnNull() {
            ...
            // When
            FormTemplateResp result = templateService.getTemplateByCode("non-existent");
    ...
    class CreateTemplateTests {
        ...
        void createTemplate_ShouldCreateTemplate() {
            // Given
            FormTemplateReq req = new FormTemplateReq(
            ...
            // When
            FormTemplateResp result = templateService.createTemplate(req);
    ...
    class UpdateTemplateTests {
        ...
        void updateTemplate_ShouldUpdateTemplate() {
            ...
            // When
            FormTemplateResp result = templateService.updateTemplate("template-001", req);
